...
const fetchContributors = (
  ...
  return new Promise((resolve, reject) => {
    const config: AxiosRequestConfig = {
      method: 'get',
      url: `https://api.github.com/repos/alvaro-brito/realcoder-icons/contributors`,
      params: { page },
      headers: {
...
const init = async () => {
  ...
  // create the image
  console.log('> Real Coder Icons:', yellow('Creating image...'));
  ...
  createScreenshot(outputPath, fileName)
    ...
    .catch((error) => {
      console.log('> Real Coder Icons:', red(`Error: ${error}`));
