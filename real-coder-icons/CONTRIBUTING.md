...
- [fileIcons.ts](https://github.com/alvaro-brito/realcoder-icons/blob/main/src/core/icons/fileIcons.ts)
- [folderIcons.ts](https://github.com/alvaro-brito/realcoder-icons/blob/main/src/core/icons/folderIcons.ts)
- [languageIcons.ts](https://github.com/alvaro-brito/realcoder-icons/blob/main/src/core/icons/languageIcons.ts)
...
In case of this example the generated file names are "graphql.js", "graphql.mjs", "graphql.cjs", "graphql.ts", "graphql.mts" and "graphql.cts". The pattern is defined in the [patterns.ts](https://github.com/alvaro-brito/realcoder-icons/blob/main/src/core/patterns/patterns.ts) file.
...
1. Add the name of the icon pack to the enum in [iconPack.ts](https://github.com/alvaro-brito/realcoder-icons/blob/e21e6b1b57f2ce0b6e7306178b26d11c60e2ca0f/src/core/models/icons/iconPack.ts)
...
3. Adjust [package.json](package.json) under `configuration.properties.realcoder-icons.activeIconPack`
4. Use the icon pack inside the [fileIcons.ts](https://github.com/alvaro-brito/realcoder-icons/blob/main/src/core/icons/fileIcons.ts),[folderIcons.ts](https://github.com/alvaro-brito/realcoder-icons/blob/main/src/core/icons/folderIcons.ts) or [languageIcons.ts](https://github.com/alvaro-brito/realcoder-icons/blob/main/src/core/icons/languageIcons.ts) files in the `enabledFor` attribute
...
You can find a list of all available color aliases in the [materialPalette.ts](https://github.com/alvaro-brito/realcoder-icons/blob/main/src/core/generator/clones/utils/color/materialPalette.ts) file.
...
```json
{
  "realcoder-icons.enableLogging": true,
  "realcoder-icons.logLevel": "debug",
}
```
...
Per default the logging is disabled as it can slow down the extension. If logging is enabled, the logs can be found in the output panel of VS Code under "Real Coder Icons".
